...
def sign_message(challenge, filename="secret_key.txt"):
    ...
    # recover your account information for your private key and sign the given challenge
    ...
    message = encode_defunct(challenge)
    acct = eth_account.Account.from_key(priv)
    signed_message = eth_account.Account.sign_message(message, private_key=priv)
